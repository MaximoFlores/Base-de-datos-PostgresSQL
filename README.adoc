== Este es un resubido de un trabajo practico realizado en gitlab para la materia de Base de datos, el link del archivo original es el siguiente:
https://gitlab.com/berinbpc/berini-carmona-faccini-flores-db1
